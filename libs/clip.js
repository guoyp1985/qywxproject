...
Clip.prototype = {
      ...
      buildFrame : function() {
              ...
              /*
               ...
               frameLeft = jQuery("<div class='clip-frame left'/>").css({"width" : width, "height" : this.cHeight, "top" : height}).insertBefore(this.clipElement),
               frameRight = jQuery("<div class='clip-frame right'/>").css({"width" : width, "height" : this.cHeight, "top" : height}).insertBefore(this.clipElement);
               */
      },
      inCenter : function() {
