  ...
  <div>
    ...
    <div class="form-item">
      <div class="t-table">
        ...
        <div class="t-cell input-cell v_middle" style="position:relative;">
          <input v-model="submitdata.param_numbers" type="tel" class="input" name="param_numbers" placeholder="几人成团" />
        </div>
    ...
    <div class="form-item">
      <div class="t-table">
        ...
        <div class="t-cell input-cell v_middle" style="position:relative;">
          <input v-model="submitdata.param_finishtime" type="tel" class="input" name="param_finishtime" placeholder="用户完成活动的最长时间,如24" />
        </div>
    ...
    <div class="form-item">
      <div class="t-table">
        ...
        <div class="t-cell input-cell v_middle" style="position:relative;">
          <input v-model="submitdata.param_everybuy" type="tel" class="input" name="param_everybuy" placeholder="单个用户最多购买团购商品数量" />
        </div>
        <div class="t-cell v_middle align_right font12" style="width:40px;">件</div>
      </div>
    </div>
