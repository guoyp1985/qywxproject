  ...
  <div class="containerarea bg-white font14 retailersetting">
    <div class="pagetop">
      <tab v-model="selectedIndex" class="v-tab">
        <tab-item v-if="query.from == 'aaa'">卖家信息设置</tab-item>
        <tab-item
          v-else
    ...
    <div class="s-container" style="top:44px;">
      ...
      <swiper v-model="selectedIndex" class="x-swiper no-indicator">
        ...
        <swiper-item v-if="selectedIndex === 1 && query.from != 'aaa'">
          <div class="swiper-inner" style="bottom:50px;">
            <form>
              <div class="form-item required">
        ...
        <div class="popup1">
          ...
          <div class="popup-middle">
            <div class="padding10">
              ...
              <div>共销汇卖家需按订单交易额（含运费）的1%承担交易手续费，最低收费金额0.01元，不足0.01元按照0.01元收取。</div>
              ...
              <div>（1）除买卖双方协商一致的，共销汇平台卖家需在买家付款后的72小时内操作发货。</div>
              ...
              <div>共销汇平台仅提供商品展示，不做任何担保交易，买卖双方在交易过程中出现的任何问题，由买卖双方协商解决。</div>
