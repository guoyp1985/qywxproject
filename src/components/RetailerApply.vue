  ...
  <div class="containerarea font14 bg-white retailerapply notop nobottom">
    <div class="pagemiddle bg-white">
      ...
      <form class="applyform pr12 pl12 pt15">
        <div v-if="(query.appid == 'wx72131ab2cb77663d' && (!query.wid || query.wid == 14)) || (query.appid == 'wx93366404c4cbc761' && (!query.wid || query.wid == 16949))" class="form-item required border1px" style="color:red;">未获取到推荐人信息，请重新扫码申请!</div>
