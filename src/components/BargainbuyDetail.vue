<template>
  <div class="containerarea font14 bargainbuydetail scroll-container" style="overflow-y:auto;">
    ...
    <div class="b_header">
      <div class="inner">
        <div class="pic">
          <x-img class="imgcover" :src="crowduser.avatar" default-src="../src/assets/images/user.jpg"></x-img>
        </div>
        ...
        <div class="innerbg">
          <router-link class="t-table" style="color:inherit;" :to="{path:'/product',query:{wid:product.uploader,id:product.id}}">
            <div class="t-cell v_middle w80">
              <x-img class="imgcover" :src="product.photo" style="width:70px;height:70px;" default-src="../src/assets/images/nopic.jpg"></x-img>
            </div>
            <div class="t-cell">
