<template>
  <div class="containerarea font14 s-havebottom store3">
      ...
      <div class="s-container scroll-container" style="top:0px;bottom:0;" ref="scrollContainer" @scroll="handleScroll('scrollContainer')">
        <div class="tophead flex_right b_bottom_after">
          <div class="flex_table" style="margin-right:auto;">
            ...
            <div class="pl10 pt5">{{retailerInfo.title}}</div>
          </div>
          <div class="db pr10" @click="toChat">
        ...
        <div class="part-area" :class="`productlist ${productdata.length == 0 ? '' : 'squarepic'}`">
          ...
          <div class="productlist squarepic pb10" v-if="disproductdata">
            <div class="bk-productitem scroll_item" v-for="(item,index) in productdata">
              <router-link class="inner" :to="{path: '/product', query: {id: item.id, wid: item.uploader}}">
                <div class="picarea">
                  <div class="pic">
                    <img :src="item.photo" />
                ...
                <div class="desbox">
                  ...
                  <div class="db-flex">
                    <div class="flex_cell flex_left">
                      <div class="w_100 clamp1 font14 bold txt1 color-store3">￥<span>{{item.price}}</span></div>
                    </div>
                    <div class="flex_cell flex_right">
                      <div class="clamp1 storebuy">购买</div>
                    </div>
                  </div>
                </div>
              </router-link>
