<template>
  <div class="containerarea font14 bg-page center-seller">
    <div class="pagemiddle">
      <div class="topcover">
        <div class="inner">
          <img src="/src/assets/images/banner_top.png" />
        </div>
      </div>
...
.topcover{position:relative;padding-bottom:55.55%;}
.topcover .inner{
  position:absolute;left:0;top:0;right:0;bottom:0;
}
.topcover .inner img{vertical-align:middle;width:100%;height:100%;object-fit: cover;}
...
.box1 .row2{margin-top:12px;padding:0 20px;box-sizing: border-box;}
.box1 .row3{margin-top:12px;padding:0 20px 15px;box-sizing: border-box;}
...
.taglist .tagitem:nth-child(odd){border-color:rgb(229, 28, 35);color:rgb(229, 28, 35);}
.taglist .tagitem:nth-child(even){border-color:rgb(0, 150, 136);color:rgb(0, 150, 136);}
.linearea{position:relative;height:8px;}
.linearea .line{
...
.linearea .line1{left:79px;}
.linearea .line2{right:79px;}

.boxouter.box2 .boxinner{box-shadow: rgb(204, 204, 204) 0px -2px 16px -3px;padding:15px 0px;}
.box2 .row1{padding:0 20px;}
.focuslist{padding-top:10px;padding-right:20px;}
.focuslist:after{
  content:'';
  display:block;
  clear:both;
...
.focuslist .pic{padding-left:20px;width:38px;}
.focuslist img{width:38px;height:38px;border-radius:50%;vertical-algin:middle;object-fit: cover;}
.focuslist .txt{padding-left:20px;width:38px;}

.center-seller .pagemiddle{top:0;bottom:50px;padding-bottom:20px;}
.center-seller .pagebottom{
...
.center-seller .pagebottom *{line-height:1.4 !important;}
.center-seller .pagebottom .item{height:100%;}
.center-seller .pagebottom .al{color:rgb(229, 28, 35);font-size:18px;}
.center-seller .pagebottom .txt{color:rgb(229, 28, 35);font-size:12px;}
</style>
