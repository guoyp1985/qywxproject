                ...
                <group>
                  <cell-box class="income-cell" v-for="(item, index) in tabdata1" :key="index" @click.native="itemClick(item)">
                    ...
                    <div class="avatar-cell w50">
                      <img class="imgcover v_middle" :src="item.photo" onerror="javascript:this.src='http://vuxlaravel.boka.cn/images/user.jpg'" />
                    </div>
              ...
              <template v-if="tabdata2.length">
                <group>
                  <cell class="wait-cell font14" v-for="(item, index) in tabdata2" :key="index">
                    <img slot="icon" class="imgcover v_middle" :src="item.photo" onerror="javascript:this.src='http://vuxlaravel.boka.cn/images/user.jpg'" />
