...
<template>
  <div class="containerarea font14 bg-white news notop nobottom">
    ...
    <template v-if="showContainer">
      ...
      <editor v-if="reward.uid == article.uploader && showEditor && !(article.fid > 0)" elem="#editor-content" :query="query" @on-save="editSave" @on-setting="editSetting" @on-delete="editDelete"></editor>
