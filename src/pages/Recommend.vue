        ...
        <div class="popup1">
          ...
          <div class="popup-middle font14">
            <div class="padding10">
              ...
              <h3 class="align_center">聚客365返点客协议</h3>
              <b>第一条：立约目的</b><br/>
              为了规范聚客365平台经营秩序，明确卖家、返点客及聚客365平台的权利义务，保障各方及消费者的合法权益，特拟定本协议。<br/>
              <b>第二条：签约主体</b><br/>
              本协议由博卡先锋软件开发有限公司（以下统称“博卡先锋”）与申请成为返点客(以下简称“返点客”或“您”)签署。<br/>
              <b>第三条：协议生效和适用范围</b><br/>
              3.1、您通过网络页面点击确认或以其他方式选择接受本协议，即表示您与聚客365平台已达成协议并同意接受本协议的全部约定内容。本协议自您申请获得聚客365平台审核通过之时起生效。<br/>
              3.2、在聚客365平台成为卖家的返点客后，在本协议有效期间，返点客于聚客365平台开展经营活动应遵守本协议的约定。<br/>
              <b> 第四条：入驻聚客365平台返点客的条件</b><br/>
              4.1、聚客365平台的卖家直接邀请您成为卖家的返点客，无需提交申请资料。<br/>
              4.2、成为卖家的返点客后，您可立即对卖家提供的商品进行分销来获得佣金，也可通过分享卖家创建的商品和文章信息获得客户，客户购买后即可获得相应金额的佣金。<br/>
              <b>第五条：聚客365平台的权利和义务</b><br/>
              5.1、聚客365平台根据本协议的约定向返点客提供信息及数据管理服务。<br/>
              5.2、聚客365平台并不作为卖家提供产品信息及产品，也不作为返点客直接销售卖家的商品，卖家与返点客由于分销发生的纠纷，聚客365平台不承担任何责任，但聚客365平台有义务提供必要的协助以促进纠纷的解决。<br/>
              5.3、因网上平台的特殊性，聚客365平台没有义务对所有返点客的信息、所有的交易行为以及有关的其他事项进行事先审查，但如存在下列情况的，聚客365平台有权根据不同情况选择保留或删除相关信息或继续、停止对该用户提供服务：<br/>
              5.3.1、用户或其他第三方通知聚客365平台，认为某个具体返点客或具体交易事项可能存在重大问题的；<br/>
              5.3.2、用户或其他第三方向聚客365平台告知卖家有违法或不当行为的；<br/>
              5.3.3、聚客365平台以普通非专业交易者的知识水平标准对相关内容进行判别，可以明显认为这些内容或行为具有违法或不当性质的；<br/>
              5.4、聚客365平台有权对返点客的基本信息、分享行为及订单交易信息进行查阅，发现存在任何问题或疑问，均有权咨询返点客，并对其行为进行处理。<br/>
              5.5、经国家生效法律文书或行政处罚决定确认返点客存在违法行为，或者聚客365平台有足够事实依据可以认定返点客存在违法或违反协议行为的，聚客365平台有权公布返点客的违法或违规行为。<br/>
              <b> 第六条：其他约定</b><br/>
              6.1、本协议适用中华人民共和国大陆地区法律。因聚客365平台与返点客就本协议的签订、履行或解释发生争议，双方应努力友好协商解决。如协商不成，聚客365平台和返点客同意由聚客365平台住所地法院管辖审理双方的纠纷或争议。<br/>
              6.2、本协议内容包括协议正文、附件及所有聚客365平台已经发布的或将来可能发布的聚客365平台规则、经营规范等文件。这些文件是本协议不可分割的一部分，与本协议具有相同法律效力。<br/>
              6.3、聚客365平台有权以修改、更新等方式不时调整本协议和相关规则的内容，相关内容将公布于聚客365平台的官方网站或以其他方式通知返点客。除非您明示并通知聚客365平台不愿接受调整后的内容，否则调整后的内容将于公布之日或通知另行指定的日期开始生效。<br/>
              <b> 第七条：补充说明</b><br/>
              如果您对本声明的条款有疑问的，请通过聚客365客服渠道进行询问，聚客365将向您解释条款内容。如果您不同意本声明的任意内容，或者无法准确理解聚客365对条款的解释，请谨慎进行后续操作。<br/>
              7.1、任何商家欲根据用户发布的商品信息进行交易或其他行为前，应慎重辨别这些信息的合法性、准确性、真实性和安全性。聚客365不对用户发布的商品信息做任何保证或承诺，包括但不限于产品来源的合法性、产品权利瑕疵、产品质量瑕疵、卖家对商品描述的真实性等问题。<br/>
              9.2、聚客365不负责审核用户发布的商品信息中的图片、文字、Logo等是否基于合法权益，如该类信息涉及侵犯第三方知识产权等相关权益，聚客365不承担任何责任。<br/>
              9.3、聚客365为用户提供的独立担保交易仅为提供货款代收代付服务，不负责处理因其他原因而产生的各种交易纠纷。<br/>
              9.4、本声明适用中华人民共和国大陆地区法律。因聚客365与用户就本声明的确认、履行或解释发生争议，双方应努力友好协商解决。如协商不成，聚客365和用户同意由聚客365住所地法院管辖审理双方的纠纷或争议。<br/>
              本声明内容包括声明正文及所有聚客365已经发布的或将来可能发布的聚客365服务的使用规则。所有规则为本声明不可分割的一部分，与声明正文具有相同法律效力。本协议未尽事宜，用户需遵守聚客365网站上公布的《聚客365服务协议》及相关规则。<br/>
            </div>
          </div>
