<template>
  <div class="containerarea">
    <div class="intro">
      <div class="inner">
        <img class="pic" src="../assets/images/index/intro.jpg">
        <ul class="txtlist">
  ...
  data () {
    return {
      ...
      skills: [{
        ...
        phone1: require('../assets/images/index/skill1phone1.png'),
        phone2: require('../assets/images/index/skill1phone2.png'),
        skillMore: '发动你的客户及朋友帮你分享，只要查看过你店铺、商品或文章的用户，都会成为你的潜在客户。访客秒变客户，微信获客可以如此简单！'
      }, {
        especial: true,
        skillTitle: '客户层级直观体现',
        skillIntro: '根据潜在的客户自动计算成交概率',
        phone1: require('../assets/images/index/skill2phone1.png'),
        phone2: require('../assets/images/index/skill2phone2.png'),
        skillMore: '系统根据每位客户的分享、浏览等行为精确计算成交概率，成交概率越高的客户证明对你的产品越感兴趣，此时可主动出击与他取得联系，有效提高销售额。'
      }, {
        skillTitle: '沟通客户主动及时',
        skillIntro: '即便不是微信好友也可直接联系',
        phone1: require('../assets/images/index/skill3phone1.png'),
        phone2: require('../assets/images/index/skill3phone2.png'),
        skillMore: '潜在客户及时不是微信好友，也可通过系统直接联系，让你与客户的沟通随时随地。'
      }, {
        skillTitle: '销售过程信任传递',
        skillIntro: '买家通过购买过的好友获取反馈',
        phone1: require('../assets/images/index/skill4phone1.png'),
        phone2: require('../assets/images/index/skill4phone2.png'),
        skillMore: '成交过程最难解决的就是“信任”问题，客户可通过商品页面查看到“本店购买过的好友”，并一键向购买过的好友咨询使用反馈，通过好友来解决买家对产品的信任问题。'
      }, {
        skillTitle: '更多的人帮你销售',
        skillIntro: '返点客让你不再一个人销售',
        phone1: require('../assets/images/index/skill5phone1.png'),
        phone2: require('../assets/images/index/skill5phone2.png'),
...
<style type="text/css">
  ...
  .close-btn{
    ...
    width: 20px;
    height: 20px;
    background: url('../assets/images/index/closebtn.png') no-repeat center;
  ...
  .intro:nth-child(1)>ul>li:nth-child(1)>span:nth-child(1){
    background: url('../assets/images/index/skill1.png') no-repeat center;
  }
  .intro:nth-child(1)>ul>li:nth-child(2)>span:nth-child(1){
    background: url('../assets/images/index/skill2.png') no-repeat center;
  }
  .intro:nth-child(1)>ul>li:nth-child(3)>span:nth-child(1){
    background: url('../assets/images/index/skill3.png') no-repeat center;
  }
  .intro:nth-child(1)>ul>li:nth-child(4)>span:nth-child(1){
    background: url('../assets/images/index/skill4.png') no-repeat center;
  }
  .intro:nth-child(1)>ul>li:nth-child(5)>span:nth-child(1){
    background: url('../assets/images/index/skill5.png') no-repeat center;
  }
  .detail{
  ...
  .detail-title{
    ...
    top: -7px;
    color: #fff;
    background: url('../assets/images/index/detailtitle.png') no-repeat center top;
    background-size: 100% auto;
  }
  ...
  .detail-item>ul>li>p{
    background: url('../assets/images/index/detailitem.png') no-repeat center top;
    font-size: 14px;
    color: #323232;
    padding-top: 15px;
    margin-top: -3px;
  ...
  .btn{
    ...
    height: 400px;
    text-align: center;
    background: url('../assets/images/index/btnbk.png') no-repeat center;
    background-size: 100% auto;
  }
  .btn>button{
    background-color: #0c7ebb;
  ...
  .detail-item>ul>li:nth-child(1){
    background: url('../assets/images/index/skill1bk.jpg') no-repeat center;
    background-size: 100% auto;
  }
  .detail-item>ul>li:nth-child(2){
    background: url('../assets/images/index/skill2bk.png') no-repeat center;
    background-size: 100% auto;
  }
  .detail-item>ul>li:nth-child(3){
    background: url('../assets/images/index/skill3bk.png') no-repeat center;
    background-size: 100% auto;
  }
  .detail-item>ul>li:nth-child(4){
    background: url('../assets/images/index/skill4bk.jpg') no-repeat center;
    background-size: 100% auto;
  }
  .detail-item>ul>li:nth-child(5){
    background: url('../assets/images/index/skill5bk.jpg') no-repeat center;
    background-size: 100% auto;
  }
</style>
