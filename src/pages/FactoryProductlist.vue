                  ...
                  <div class="con">
                    ...
                    <div class="form-item required bg-white">
                      <div class="t-table">
                        ...
                        <div class="t-cell input-cell v_middle" style="position:relative;">
                          <x-input v-model="submitData.accountname" type="text" class="input priceInput" name="username" placeholder="开户名"></x-input>
                        </div>
                      </div>
                    </div>
                    <div class="form-item required bg-white">
                      <div class="t-table">
                        ...
                        <div class="t-cell input-cell v_middle" style="position:relative;">
                          <x-input v-model="submitData.newbankcardno" :max="23" maxlength="23" size="23" type="text" class="input priceInput" name="username" placeholder="开户账号"></x-input>
                        </div>
                      </div>
                    </div>
                    <div class="form-item required bg-white">
                      <div class="t-table">
                        ...
                        <div class="t-cell input-cell v_middle" style="position:relative;">
                          <x-input v-model="submitData.newbankuser" :max="6" maxlength="6" size="6" type="text" class="input priceInput" name="username" placeholder="联系人"></x-input>
                        </div>
                      </div>
                    </div>
                    <div class="form-item required bg-white">
                      <div class="t-table">
                        ...
                        <div class="t-cell input-cell v_middle" style="position:relative;">
                          <x-input v-model="submitData.mobile" :max="11" maxlength="11" size="11" type="text" class="input priceInput" name="username" placeholder="手机号"></x-input>
                        </div>
                      </div>
                    </div>
                  </div>
