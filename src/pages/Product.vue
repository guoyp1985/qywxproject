...
.product .videoarea .close-icon{position:absolute;left:50%;top:5px;width:80px;height:40px;margin-left:-40px;background-color:rgba(255,255,255,0.3);color:#fff;border-radius:10px;}
