    ...
    <template v-if="showContainer">
      ...
      -->
        ...
        <div class="padding10 align_right">
          ...
          <x-button v-if="orderData.canservice" mini @click.native="afterSale" class="font12">申请售后</x-button>
      ...
      <div class="bg-theme flex_center color-white fix-home-icon" @click="toHome" v-if="query.from || query.fromapp === 'qxb'">
