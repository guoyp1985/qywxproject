    ...
    <div class="s-topbanner s-topbanner1 bg-white">
      <div class="row">
        <tab v-model="selectedIndex" class="v-tab">
          <tab-item selected @on-item-click="clickTab(0)">客户买家秀</tab-item>
          <tab-item @on-item-click="clickTab(1)">邀请客户</tab-item>
          <tab-item @on-item-click="clickTab(2)">全部买家秀</tab-item>
        </tab>
      </div>
    </div>
