...
.card-detail-page{
  ...
  .btn{width:80%;max-width:300px;height:40px;line-height:40px;text-align:center;border-radius:60px;background-color:#eb6b5e;color:#fff;margin:20px auto 10px;}
}
.share-modal{
    ...
    <template v-if="viewData && viewData.id">
      <template v-if="viewData.type == 'cardcommon'">
        <div class="box-outer">
          ...
          <div class="btn" @click="clickShare">立即核销</div>
