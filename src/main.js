...
let excludeUrls = [
  { url: `${ENV.BokaApi}/api/authLogin/*`, reqMax: 2 },
  { url: `${ENV.BokaApi}/api/qrcode/login*`, reqMax: 2 },
  { url: `${ENV.BokaApi}/api/login/*`, reqMax: 2 },
  { url: `${ENV.BokaApi}/api/scanlogin`, reqMax: 2 },
